...
<html lang="en">
	...
	<body>
		...
		<div class ="box">
			<h1>Delete Lecturer</h1><br>
			
			<form action="delete_lecturer_2.php" method="GET">
				
				<input type="hidden" name="LecturerID" value="<?php echo trim($_GET["LecturerID"]); ?>"/>
				<h2>Are you sure to delete this Lecturer?</h2>
				
				<pre><input type="button" style='margin-left:0.05%;margin-top:1.5%' value="No" onclick="window.location='manage_lecturer.php';"><input type="submit" style='margin-left:1%;margin-top:1.5%' value="Yes"></pre>
			</form>
		</div>
