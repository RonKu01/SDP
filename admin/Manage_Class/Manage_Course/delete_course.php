...
<html lang="en">
	...
	<body>
		...
		<div class="box">	
			<pre><h1>Delete Course           </h1></pre><br>
		
		<form action="delete_course_2.php" method="GET">
		
			<input type="hidden" name="CourseID" value="<?php echo trim($_GET["CourseID"]); ?>"/>
			<h2>Are you sure to delete this Course?</h2>
			
			<pre><input type="button" style='margin-left:0.05%;margin-top:1.5%' value="No" onclick="window.location='manage_course.php';"><input type="submit" style='margin-left:1%;margin-top:1.5%' value="Yes"></pre>
