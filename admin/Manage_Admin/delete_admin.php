...
<html lang="en">
	...
	<body>
		...
		<div class ="box">
			...
			<form action="delete_admin_2.php" method="GET">
				
				<input type="hidden" name="Admin_ID" value="<?php echo trim($_GET["Admin_ID"]); ?>"/>
				<h2>Are you sure to delete this Admin?</h2>
				
				<pre><input type="button" style='margin-left:0.05%;margin-top:1.5%' value="No" onclick="window.location='manage_profile.php';"> <input type="submit"  style='margin-left:1%;margin-top:1.5%' value="Yes"></pre>
