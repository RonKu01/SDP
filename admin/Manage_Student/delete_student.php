...
<html lang="en">
	...
	<body>
		...
		<div class ="box">
			...
			<form action="delete_student_2.php" method="GET">
				
				<input type="hidden" name="StudentTP" value="<?php echo trim($_GET["StudentTP"]); ?>"/>
				<h2>Are you sure to delete this Student?</h2>
				
				<pre><input type="button" style='margin-left:0.05%;margin-top:1.5%' value="No" onclick="window.location='manage_student.php';"><input type="submit" style='margin-left:1%;margin-top:1.5%' value="Yes"></pre>
			</form>
		</div>
