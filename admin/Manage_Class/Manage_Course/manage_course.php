...
<html>
	...
	<body>
		...
		<div class="box">
			...
			<pre><input type="text" style='width:auto;' id="SearchBoxID" onkeyup="SearchID()" placeholder="Search by CourseID." title="Type in a CourseID">      <input type="text" style='width:auto;' id="SearchBoxName" onkeyup="SearchName()" placeholder="Search by CourseName." title="Type in a Course Name"></pre>
			
			
			<div class='scroll-table'>
				<table border = 1 style = 'text-align: center;  font-size: 25px;' id="Course_List">
					<tr bgcolor = 'f8fca2'>
						<th>Course ID</th>
						<th>Course Name</th>
						<th>Edit</th>
					...
					if (!empty($result) && $result->num_rows > 0) {
						for ($i = 0; $i < mysqli_num_rows($result); $i++){
							...
							echo '<td><a href = "edit_course.php?CourseID='.$row['CourseID'].'"><button class="editbutton"> √ </button></a></td>';
							echo '<td><a href = "delete_course.php?CourseID='.$row['CourseID'].'"><button class="deletebutton"> X </button></a></td>';
							echo '</tr>';
						}
					}
			...
			<input type="button" class='addbutton' style='font-size: 20px;' value="Add Course" onclick="window.location='add_course.php';">
		</div>
